    ...
    <div>
        <FormControl>
            ...
            <Select
                ...
                value={produto.id}
                onChange={(e) => {
                    dispatchProdutos({ type: 'ADD_PRODUTO_INFORMACAO', index, produto: findProdutoID(e.target.value) })
                }}
            >
            ...
            <CurrencyFormat
                ...
                onValueChange={(e) => {
                    dispatchProdutos({ type: 'EDITAR_PRODUTO', index, quantidade: e.value })
                }}
                thousandSeparator={"."}
                decimalScale={3}
                decimalSeparator={","}
            ...
            <CurrencyFormat
                ...
                onValueChange={(e) => {
                    dispatchProdutos({ type: 'EDITAR_PRODUTO', index, valorVenda: e.value })
                }}
                prefix={"R$"}
                thousandSeparator={"."}
                decimalScale={2}
